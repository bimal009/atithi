...
export default async function CabinsPage2({ params }: { params: Promise<{ tenant: string }> }) {
    ...
    <SiteShell2 tenant={tenant} active="cabins">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-14 sm:px-6 sm:py-16 lg:px-10">
        <div className="flex flex-col gap-2">
          <h1 className="font-[family-name:var(--font-site2-display)] text-4xl font-semibold">Cabins</h1>
          <p className="text-[#17181A]/55">For guests who want a little more room to breathe.</p>
        </div>
