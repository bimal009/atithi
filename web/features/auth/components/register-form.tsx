...
import { API_BASE, LOGIN_ROUTE } from "../constants";
        ...
        <CardContent className="p-8 relative">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-center text-muted-foreground text-sm mt-1.5">
              Sign up to get started with Atithi
            </p>
          </div>
          ...
          <form onSubmit={onSubmit} noValidate>
            <FieldGroup className="gap-4">
              ...
              >
                {registerUser.isPending && <Spinner className="size-4" />}
                <span>{registerUser.isPending ? "Creating Account..." : "Create Account"}</span>
              </Button>
