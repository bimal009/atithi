...
type CreateRoomTypeRequest struct {
	...
	PricingUnit  *string  `json:"pricingUnit,omitempty" validate:"omitempty,oneof=night hour daycation package"`
	PricingLabel *string  `json:"pricingLabel,omitempty" validate:"omitempty,max=100"`
